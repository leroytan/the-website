...
class TestStartupEmail:
    ...
    def test_send_startup_notification_email_success(self, mock_settings, mock_datetime, 
                                                     mock_gethostname, mock_send_email):
    ...
    @patch('api.startup_email.datetime')
    @patch('api.startup_email.settings')
    def test_send_startup_notification_email_send_failure(self, mock_settings, mock_datetime,
                                                          mock_gethostname, mock_send_email):
    ...
    @patch('api.startup_email.socket.gethostname')
    @patch('api.startup_email.settings')
    def test_send_startup_notification_email_exception(self, mock_settings, mock_gethostname):
    ...
    @patch('api.startup_email.datetime')
    @patch('api.startup_email.settings')
    def test_send_startup_notification_email_content_format(self, mock_settings, mock_datetime,
                                                            mock_gethostname, mock_send_email):
    ...
    @patch('api.startup_email.datetime')
    @patch('api.startup_email.settings')
    def test_send_startup_notification_email_missing_message_id(self, mock_settings, mock_datetime,
                                                               mock_gethostname, mock_send_email):
