...
class TestPaymentRouter:
    ...
    async def test_create_checkout_session_success(self):
        ...
        with patch(
            "api.logic.auth_logic.AuthLogic.create_assert_user_authorized"
        ) as mock_assert:
            with patch(
                "api.logic.payment_logic.PaymentLogic.handle_payment_request"
            ) as mock_handle:
    ...
    def test_stripe_webhook_success(self):
        ...
        with patch(
            "api.logic.payment_logic.PaymentLogic.handle_stripe_webhook"
        ) as mock_handle:
            ...
            with patch("fastapi.Request.body") as mock_body:
                with patch("fastapi.Request.headers") as mock_headers:
                    ...
                    mock_handle.assert_called_once_with(
                        b"test_payload", "whsec_test_signature"
                    )
