...
class TestPaymentLogicExtended:
    ...
    def test_handle_payment_request_success(self, mock_get_owner_id, mock_get_duration, 
                                           mock_get_rate, mock_create_session):
        ...
        assert line_items[0]['price_data']['unit_amount'] == 10000  # 2 hours * $50 * 100 cents
        ...
        assert call_args['success_url'] == f"https://example.com/success?session_id={{CHECKOUT_SESSION_ID}}&tutor_id=789&chat_id=101"
    ...
    @patch('api.logic.payment_logic.AssignmentLogic.get_lesson_duration')
    @patch('api.logic.payment_logic.AssignmentLogic.get_assignment_owner_id')
    def test_handle_payment_request_stripe_error(self, mock_get_owner_id, mock_get_duration,
                                                mock_get_rate, mock_create_session):
        ...
        # Mock stripe error
        import stripe
        mock_create_session.side_effect = stripe.error.StripeError("Test error", "Test message")
    ...
    def test_handle_stripe_webhook_success(self, mock_session, mock_send_email, 
                                          mock_unlock_chat, mock_get_chat, 
                                          mock_accept_request, mock_construct_event):
        ...
        mock_construct_event.assert_called_once_with(b"test_payload", "test_signature", 
                                                    ANY)  # settings.stripe_webhook_secret
    ...
    @pytest.mark.logic
    @patch('api.logic.payment_logic.stripe.Webhook.construct_event')
    def test_handle_stripe_webhook_signature_verification_failed(self, mock_construct_event):
    ...
    @patch('api.logic.payment_logic.ChatLogic.unlock_chat')
    @patch('api.logic.payment_logic.Session')
    def test_handle_stripe_webhook_missing_metadata(self, mock_session, mock_unlock_chat,
                                                   mock_get_chat, mock_accept_request, 
    ...
    def test_payment_calculation_logic(self):
        ...
        for duration_minutes, hourly_rate, expected_cents in test_cases:
            ...
            assert fee == expected_cents, f"Failed for {duration_minutes}min at ${hourly_rate}/hr"
