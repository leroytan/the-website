...
from api.storage.models import AssignmentRequestStatus, AssignmentStatus
...
class TestAssignmentLogic:
    ...
    def test_new_assignment_success(self):
        ...
        with patch("api.logic.assignment_logic.Session") as mock_session_class:
            ...
            with patch(
                "api.logic.assignment_logic.Assignment"
    ...
    def test_update_assignment_by_id_success(self):
        ...
        with patch("api.logic.assignment_logic.Session") as mock_session_class:
            ...
            with patch(
                "api.logic.assignment_logic.StorageService.update"
            ) as mock_update:
                ...
                with patch(
                    "api.logic.assignment_logic.StorageService.delete"
                ) as mock_delete:
                    with patch(
                        "api.logic.assignment_logic.StorageService.insert"
                    ) as mock_insert:
    ...
    def test_request_assignment_success(self):
        ...
        with patch("api.logic.assignment_logic.Session") as mock_session_class:
            ...
            with patch(
                "api.logic.assignment_logic.GmailEmailService.notify_new_assignment_request"
            ) as mock_email:
                # Test assignment request
                AssignmentLogic.request_assignment(
                    assignment_request_data, tutor_id, origin
                )
    ...
    def test_search_assignments_success(self):
        ...
        with patch("api.logic.assignment_logic.Session") as mock_session_class:
            ...
            with patch(
                "api.logic.assignment_logic.FilterLogic.parse_filters"
            ) as mock_parse_filters:
                mock_parse_filters.return_value = {"subject": ["Mathematics"]}

                with patch(
                    "api.logic.assignment_logic.SortLogic.get_sorting"
                ) as mock_get_sorting:
