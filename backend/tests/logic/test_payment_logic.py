...
class TestPaymentLogic:
    ...
    @patch('api.logic.payment_logic.stripe')
    @patch('api.logic.payment_logic.AssignmentLogic')
    def test_handle_payment_request_stripe_error(self, mock_assignment_logic, mock_stripe):
    ...
    def test_handle_stripe_webhook_success(self, mock_email_service, mock_storage_service, mock_chat_logic, mock_assignment_logic, mock_stripe):
        ...
        mock_assignment_logic.accept_assignment_request.return_value = (1, 2)  # owner_id, requester_id
        ...
        with patch('api.logic.payment_logic.Session') as mock_session_class:
            ...
            mock_session.query.return_value.filter_by.return_value.first.side_effect = [mock_tutor, mock_assignment_request]
    ...
    def test_handle_stripe_webhook_signature_verification_failed(self, mock_stripe):
        ...
        mock_stripe.Webhook.construct_event.side_effect = Exception("Signature verification failed")
    ...
    def test_handle_stripe_webhook_other_event_type(self, mock_stripe):
        ...
        assert result is None  # The method doesn't return anything for non-payment events 