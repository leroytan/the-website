...
class TestFilterLogic:
    ...
    def test_parse_filters_mixed_types(self):
        ...
        filters = ["subject_math", "subject_science", "level_beginner", "level_intermediate"]
        result = FilterLogic.parse_filters(filters)
        assert result == {
    ...
    def test_get_filters_tutor(self, mock_get_filter):
        ...
        mock_get_filter.side_effect = lambda table_class: mock_subjects if table_class == Subject else mock_levels
