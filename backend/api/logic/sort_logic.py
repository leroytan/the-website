...
from api.storage.models import Assignment, Level, Tutor
...
class SortLogic:
    ...
    def get_allowed_orders(field: AssignmentSortField) -> list[SortOrder]:
        ...
        match field:
            case (
                AssignmentSortField.CREATED_AT
                | AssignmentSortField.estimated_rate_hourly
                | AssignmentSortField.WEEKLY_FREQUENCY
                | AssignmentSortField.LEVEL
